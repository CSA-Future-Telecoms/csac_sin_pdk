...
def SiN300nm_1310nm_TE_STRIP_2x1_MMI()->gf.Component:
    ...
    .. plot::
      ...
      c = csac_sin_pdk.sin300.oband.cells.SiN300nm_1310nm_TE_STRIP_2x1_MMI()
      c.plot()
    '''
    def add_ports(cell):
...
def SiN300nm_1310nm_TE_STRIP_2x2_MMI()->gf.Component:
    ...
    .. plot::
      ...
      c = csac_sin_pdk.sin300.oband.cells.SiN300nm_1310nm_TE_STRIP_2x2_MMI()
      c.plot()
    '''
    def add_ports(c):
...
def SiN300nm_1310nm_TE_STRIP_90_Degree_bend()->gf.Component:
    ...
    .. plot::
      ...
      c = csac_sin_pdk.sin300.oband.cells.SiN300nm_1310nm_TE_STRIP_90_Degree_bend()
      c.plot()
    '''
    def add_ports(c): 
...
def SiN300nm_1310nm_TE_STRIP_Grating()->gf.Component:
    ...
    .. plot::
      ...
      c = csac_sin_pdk.sin300.oband.cells.SiN300nm_1310nm_TE_STRIP_Grating()
      c.plot()
    '''
    def add_ports(c):
...
def SiN300nm_1310nm_TE_STRIP_Waveguide()->gf.Component:
    ...
    .. plot::
      ...
      c = csac_sin_pdk.sin300.oband.cells.SiN300nm_1310nm_TE_STRIP_Waveguide()
      c.plot()
    '''
    def add_ports(c):
